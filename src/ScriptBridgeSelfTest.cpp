...
static bool RunBehaviorBridgeScriptSelfTest(CKContext *context,
    ...
    source += "    if (e3d !is null) { VxVector p; VxQuaternion q; e3d.SetPosition(p); e3d.SetPosition(0.0f, 0.0f, 0.0f); e3d.GetPosition(p); e3d.Translate(p); e3d.Translate(0.0f, 0.0f, 0.0f); e3d.SetQuaternion(q); e3d.GetQuaternion(q); e3d.SetScale(p); e3d.SetScale(1.0f, 1.0f, 1.0f); e3d.GetScale(p); e3d.LookAt(p); Entity3DRef@ parent3d = e3d.Parent(); Entity3DRef@ child3d = e3d.Child(0); array<Entity3DRef@>@ children3d = e3d.Children(); e3d.ChildCount(); e3d.SetParent(parent3d); e3d.AddChild(child3d); e3d.RemoveChild(child3d); e3d.IsAncestorOf(child3d); e3d.IsDescendantOf(parent3d); }\n";
    source += "    if (e2d !is null) { Entity2DRef@ parent2d = e2d.Parent(); Entity2DRef@ child2d = e2d.Child(0); array<Entity2DRef@>@ children2d = e2d.Children(); e2d.ChildCount(); e2d.SetParent(parent2d); e2d.IsAncestorOf(child2d); e2d.IsDescendantOf(parent2d); }\n";
