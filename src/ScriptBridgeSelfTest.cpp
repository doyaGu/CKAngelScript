...
static bool RunBehaviorBridgeScriptSelfTest(CKContext *context,
    ...
    source += "    if (material !is null) { material.Texture(); material.SetTexture(texture); }\n";
