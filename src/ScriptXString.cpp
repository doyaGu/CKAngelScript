...
void RegisterXString(asIScriptEngine *engine) {
    ...
    r = engine->RegisterObjectType("XString", sizeof(XString), asOBJ_VALUE | asGetTypeTraits<XString>()); CKAS_CHECK_REGISTER(r);

    // r = engine->RegisterStringFactory("XString", GetXStringFactorySingleton()); CKAS_CHECK_REGISTER(r);

    // Constructors
    r = engine->RegisterObjectBehaviour("XString", asBEHAVE_CONSTRUCT, "void f()", asFUNCTIONPR([](XString *self) { new(self) XString(); }, (XString *), void), asCALL_CDECL_OBJLAST); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectBehaviour("XString", asBEHAVE_CONSTRUCT, "void f(const XString &in other)", asFUNCTIONPR([](const XBaseString &other, XString *self) { new(self) XString(other); }, (const XBaseString &, XString *), void), asCALL_CDECL_OBJLAST); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectBehaviour("XString", asBEHAVE_CONSTRUCT, "void f(const string &in str)", asFUNCTIONPR(ConstructXString, (const std::string &, XString *), void), asCALL_CDECL_OBJLAST); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectBehaviour("XString", asBEHAVE_CONSTRUCT, "void f(int length)", asFUNCTIONPR([](int length, XString *self) { new(self) XString(length); }, (int, XString *), void), asCALL_CDECL_OBJLAST); CKAS_CHECK_REGISTER(r);

    // Destructor
    r = engine->RegisterObjectBehaviour("XString", asBEHAVE_DESTRUCT, "void f()", asFUNCTIONPR([](XString *self) { self->~XString(); }, (XString *), void), asCALL_CDECL_OBJLAST); CKAS_CHECK_REGISTER(r);

    // Methods
    r = engine->RegisterObjectMethod("XString", "XString &opAssign(const XString &in other)", asMETHODPR(XString, operator=, (const XString &), XString &), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "XString &opAssign(const string &in str)", asFUNCTIONPR(XStringAssign, (const std::string &, XString &), XString &), asCALL_CDECL_OBJLAST); CKAS_CHECK_REGISTER(r);
    ...
    r = engine->RegisterObjectMethod("XString", "XString &opAddAssign(uint8 v)", asMETHODPR(XString, operator+=, (const char), XString &), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "XString &opAddAssign(int v)", asMETHODPR(XString, operator+=, (const int), XString &), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "XString &opAddAssign(float v)", asMETHODPR(XString, operator+=, (const float), XString &), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);

    r = engine->RegisterObjectMethod("XString", "XString opAdd(const XString &in str) const", asMETHODPR(XString, operator+, (const XBaseString &) const, XString), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "XString opAdd(const string &in str) const", asFUNCTIONPR(XStringAdd, (const std::string &, const XString &), XString), asCALL_CDECL_OBJLAST); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "XString opAdd(uint8 v) const", asMETHODPR(XString, operator+, (const char) const, XString), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "XString opAdd(int v) const", asMETHODPR(XString, operator+, (const int) const, XString), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "XString opAdd(float v) const", asMETHODPR(XString, operator+, (const float) const, XString), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    ...
    r = engine->RegisterObjectMethod("XString", "bool Empty() const", asMETHODPR(XString, Empty, () const, XBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
#endif
    r = engine->RegisterObjectMethod("XString", "uint16 Length() const", asMETHODPR(XString, Length, () const, XWORD), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "uint16 Capacity() const", asMETHODPR(XString, Capacity, (), XWORD), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "void Resize(uint16 length)", asMETHODPR(XString, Resize, (XWORD), void), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "void Reserve(uint16 length)", asMETHODPR(XString, Reserve, (XWORD), void), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);

    r = engine->RegisterObjectMethod("XString", "XString &ToUpper()", asMETHODPR(XString, ToUpper, (), XString &), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "XString &ToLower()", asMETHODPR(XString, ToLower, (), XString &), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);

    r = engine->RegisterObjectMethod("XString", "int Compare(const XString &in str) const", asMETHODPR(XString, Compare, (const XBaseString &) const, int), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "int NCompare(const XString &in str, int n) const", asMETHODPR(XString, NCompare, (const XBaseString &, const int) const, int), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "int ICompare(const XString &in str) const", asMETHODPR(XString, ICompare, (const XBaseString &) const, int), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
#if CKVERSION == 0x13022002
    r = engine->RegisterObjectMethod("XString", "int NICompare(const XString &in str, int n) const", asMETHODPR(XString, NICompare, (const XBaseString &, const int) const, int), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
#endif
    ...
    r = engine->RegisterObjectMethod("XString", "bool EndsWith(const XString &in str) const", asMETHODPR(XString, EndsWith, (const XBaseString &) const, XBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "bool IEndsWith(const XString &in str) const", asMETHODPR(XString, IEndsWith, (const XBaseString &) const, XBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
#endif
    ...
    r = engine->RegisterObjectMethod("XString", "int Replace(uint8 src, uint8 dest)", asMETHODPR(XString, Replace, (char, char), int), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XString", "int Replace(const XString &in srt, const XString &in dest)", asMETHODPR(XString, Replace, (const XBaseString &, const XBaseString &), int), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
}
