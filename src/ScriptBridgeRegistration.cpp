...
void RegisterBehaviorMethods(asIScriptEngine *engine, int &r) {
    ...
    r = engine->RegisterObjectMethod("BehaviorGraphEdit", "BehaviorGraphEdit@ EnsureInputCount(GraphEditNode@+ node, int count, const string &in prefix = \"\")", asMETHOD(BehaviorGraphEdit, EnsureInputCount), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("BehaviorGraphEdit", "BehaviorGraphEdit@ EnsureOutputCount(GraphEditNode@+ node, int count, const string &in prefix = \"\")", asMETHOD(BehaviorGraphEdit, EnsureOutputCount), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
