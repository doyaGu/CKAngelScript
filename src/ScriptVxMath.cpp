...
static void RegisterVxVector4(asIScriptEngine *engine) {
    ...
    r = engine->RegisterObjectMethod("VxVector4", "VxVector4 opAdd(const VxVector4 &in v) const", asFUNCTIONPR([](const VxVector4 &lhs, const VxVector4 &rhs) { return lhs + rhs; }, (const VxVector4 &, const VxVector4 &), VxVector4), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    r = engine->RegisterObjectMethod("VxVector4", "VxVector4 opSub(const VxVector4 &in v) const", asFUNCTIONPR([](const VxVector4 &lhs, const VxVector4 &rhs) { return lhs - rhs; }, (const VxVector4 &, const VxVector4 &), VxVector4), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    r = engine->RegisterObjectMethod("VxVector4", "VxVector4 opMul(const VxVector4 &in v) const", asFUNCTIONPR([](const VxVector4 &lhs, const VxVector4 &rhs) { return lhs * rhs; }, (const VxVector4 &, const VxVector4 &), VxVector4), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    r = engine->RegisterObjectMethod("VxVector4", "VxVector4 opDiv(const VxVector4 &in v) const", asFUNCTIONPR([](const VxVector4 &lhs, const VxVector4 &rhs) { return lhs / rhs; }, (const VxVector4 &, const VxVector4 &), VxVector4), asCALL_CDECL_OBJFIRST); assert(r >= 0);
