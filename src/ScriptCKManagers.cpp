...
void RegisterCKPluginManager(asIScriptEngine *engine) {
    ...
    r = engine->RegisterObjectMethod("CKPluginManager", "int GetCategoryCount() const", asMETHODPR(CKPluginManager, GetCategoryCount, (), int), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
