...
static void RegisterCKMeshMembers(asIScriptEngine *engine, const char *name) {
    ...
    r = engine->RegisterObjectMethod(name, "void AddPreRenderCallBack(CK_MESHRENDERCALLBACK@ callback, bool temporary = false)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc, bool temporary) -> bool {
        scriptFunc->AddRef(); if (temporary) MarkAsTemporary(scriptFunc); bool result = self->AddPreRenderCallBack(CKMesh_MeshRenderCallback, scriptFunc, temporary); if (!result) { if (temporary) ClearTemporaryMark(scriptFunc); scriptFunc->Release(); } return result;
    ...
    r = engine->RegisterObjectMethod(name, "void RemovePreRenderCallBack(CK_MESHRENDERCALLBACK@ callback)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc) -> bool {
        bool result = self->RemovePreRenderCallBack(CKMesh_MeshRenderCallback, scriptFunc); if (result) { if (IsMarkedAsReleasedOnce(scriptFunc)) ClearReleasedOnceMark(scriptFunc); else scriptFunc->Release(); } return result;
    ...
    r = engine->RegisterObjectMethod(name, "void AddPostRenderCallBack(CK_MESHRENDERCALLBACK@ callback, bool temporary = false)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc, bool temporary) -> bool {
        scriptFunc->AddRef(); if (temporary) MarkAsTemporary(scriptFunc); bool result = self->AddPostRenderCallBack(CKMesh_MeshRenderCallback, scriptFunc, temporary); if (!result) { if (temporary) ClearTemporaryMark(scriptFunc); scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *, bool), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    r = engine->RegisterObjectMethod(name, "void RemovePostRenderCallBack(CK_MESHRENDERCALLBACK@ callback)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc) -> bool {
        bool result = self->RemovePostRenderCallBack(CKMesh_MeshRenderCallback, scriptFunc); if (result) { if (IsMarkedAsReleasedOnce(scriptFunc)) ClearReleasedOnceMark(scriptFunc); else scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    ...
    r = engine->RegisterObjectMethod(name, "void AddSubMeshPreRenderCallBack(CK_SUBMESHRENDERCALLBACK@ callback, bool temporary = false)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc, bool temporary) -> bool {
        scriptFunc->AddRef(); if (temporary) MarkAsTemporary(scriptFunc); bool result = self->AddSubMeshPreRenderCallBack(CKMesh_SubMeshRenderCallback, scriptFunc, temporary); if (!result) { if (temporary) ClearTemporaryMark(scriptFunc); scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *, bool), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    r = engine->RegisterObjectMethod(name, "void RemoveSubMeshPreRenderCallBack(CK_SUBMESHRENDERCALLBACK@ callback)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc) -> bool {
        bool result = self->RemoveSubMeshPreRenderCallBack(CKMesh_SubMeshRenderCallback, scriptFunc); if (result) { if (IsMarkedAsReleasedOnce(scriptFunc)) ClearReleasedOnceMark(scriptFunc); else scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    ...
    r = engine->RegisterObjectMethod(name, "void AddSubMeshPostRenderCallBack(CK_SUBMESHRENDERCALLBACK@ callback, bool temporary = false)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc, bool temporary) -> bool {
        scriptFunc->AddRef(); if (temporary) MarkAsTemporary(scriptFunc); bool result = self->AddSubMeshPostRenderCallBack(CKMesh_SubMeshRenderCallback, scriptFunc, temporary); if (!result) { if (temporary) ClearTemporaryMark(scriptFunc); scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *, bool), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    r = engine->RegisterObjectMethod(name, "void RemoveSubMeshPostRenderCallBack(CK_SUBMESHRENDERCALLBACK@ callback)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc) -> bool {
        bool result = self->RemoveSubMeshPostRenderCallBack(CKMesh_SubMeshRenderCallback, scriptFunc); if (result) { if (IsMarkedAsReleasedOnce(scriptFunc)) ClearReleasedOnceMark(scriptFunc); else scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
...
static void RegisterCKRenderObjectMembers(asIScriptEngine *engine, const char *name) {
    ...
    r = engine->RegisterObjectMethod(name, "void AddPreRenderCallBack(CK_RENDEROBJECT_CALLBACK@ callback, bool temporary = false)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc, bool temporary) -> bool {
        scriptFunc->AddRef(); if (temporary) MarkAsTemporary(scriptFunc); bool result = self->AddPreRenderCallBack(CKRenderObject_Callback, scriptFunc, temporary); if (!result) { if (temporary) ClearTemporaryMark(scriptFunc); scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *, bool), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    r = engine->RegisterObjectMethod(name, "void RemovePreRenderCallBack(CK_RENDEROBJECT_CALLBACK@ callback)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc) -> bool {
        bool result = self->RemovePreRenderCallBack(CKRenderObject_Callback, scriptFunc); if (result) { if (IsMarkedAsReleasedOnce(scriptFunc)) ClearReleasedOnceMark(scriptFunc); else scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    ...
    r = engine->RegisterObjectMethod(name, "void AddPostRenderCallBack(CK_RENDEROBJECT_CALLBACK@ callback, bool temporary = false)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc, bool temporary) -> bool {
        scriptFunc->AddRef(); if (temporary) MarkAsTemporary(scriptFunc); bool result = self->AddPostRenderCallBack(CKRenderObject_Callback, scriptFunc, temporary); if (!result) { if (temporary) ClearTemporaryMark(scriptFunc); scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *, bool), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
    r = engine->RegisterObjectMethod(name, "void RemovePostRenderCallBack(CK_RENDEROBJECT_CALLBACK@ callback)", asFUNCTIONPR([](T *self, asIScriptFunction *scriptFunc) -> bool {
        bool result = self->RemovePostRenderCallBack(CKRenderObject_Callback, scriptFunc); if (result) { if (IsMarkedAsReleasedOnce(scriptFunc)) ClearReleasedOnceMark(scriptFunc); else scriptFunc->Release(); } return result;
    }, (T *, asIScriptFunction *), bool), asCALL_CDECL_OBJFIRST); assert(r >= 0);
