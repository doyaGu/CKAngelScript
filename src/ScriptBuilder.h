#ifndef CKAS_SCRIPTBUILDER_H
#define CKAS_SCRIPTBUILDER_H
...
typedef int (*ScriptBuilderIncludeCallback)(const char *include, const char *from, ScriptBuilder *builder, void *userParam);
...
typedef int(*ScriptBuilderPragmaCallback)(const std::string &pragmaText, ScriptBuilder &builder, void *userParam);
...
public:
	...
	void SetIncludeCallback(ScriptBuilderIncludeCallback callback, void *userParam);

	// Register the callback for resolving pragma directive
	void SetPragmaCallback(ScriptBuilderPragmaCallback callback, void *userParam);
...
protected:
	...
	ScriptBuilderIncludeCallback  includeCallback;
	void              *includeParam;

	ScriptBuilderPragmaCallback  pragmaCallback;
	void             *pragmaParam;
