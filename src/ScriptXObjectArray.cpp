...
void RegisterXSObjectPointerArray(asIScriptEngine *engine) {
    ...
    r = engine->RegisterObjectMethod("XSObjectPointerArray", "bool AddIfNotHere(CKObject@ obj)", asMETHODPR(XSObjectPointerArray, AddIfNotHere, (CKObject *), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    ...
    r = engine->RegisterObjectMethod("XSObjectPointerArray", "bool FindObject(CKObject@ obj) const", asMETHODPR(XSObjectPointerArray, FindObject, (CKObject *) const, CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XSObjectPointerArray", "bool Check()", asMETHODPR(XSObjectPointerArray, Check, (), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
...
void RegisterXSObjectArray(asIScriptEngine *engine) {
    ...
    r = engine->RegisterObjectMethod("XSObjectArray", "void ConvertToObjects(CKContext@ context, XSObjectPointerArray &out objArray) const", asMETHODPR(XSObjectArray, ConvertToObjects, (CKContext *Context, XSArray<CKObject *> &) const, void), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    ...
    r = engine->RegisterObjectMethod("XSObjectArray", "bool Check(CKContext@ context)", asMETHODPR(XSObjectArray, Check, (CKContext *), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XSObjectArray", "bool AddIfNotHere(CK_ID id)", asMETHODPR(XSObjectArray, AddIfNotHere, (CK_ID), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XSObjectArray", "bool AddIfNotHere(CKObject@ obj)", asMETHODPR(XSObjectArray, AddIfNotHere, (CKObject *), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XSObjectArray", "CKObject@ GetObject(CKContext@ context, uint i) const", asMETHODPR(XSObjectArray, GetObject, (CKContext *, unsigned int) const, CKObject *), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    ...
    r = engine->RegisterObjectMethod("XSObjectArray", "bool FindObject(CKObject@ obj) const", asMETHODPR(XSObjectArray, FindObject, (CKObject *) const, CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XSObjectArray", "bool FindID(CK_ID id) const", asMETHODPR(XSObjectArray, FindID, (CK_ID) const, CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
...
void RegisterXObjectPointerArray(asIScriptEngine *engine) {
    ...
    r = engine->RegisterObjectMethod("XObjectPointerArray", "bool AddIfNotHere(CKObject@ obj)", asMETHODPR(XObjectPointerArray, AddIfNotHere, (CKObject *), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    ...
    r = engine->RegisterObjectMethod("XObjectPointerArray", "bool FindObject(CKObject@ obj) const", asMETHODPR(XObjectPointerArray, FindObject, (CKObject *) const, CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XObjectPointerArray", "bool Check()", asMETHODPR(XObjectPointerArray, Check, (), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
...
void RegisterXObjectArray(asIScriptEngine *engine) {
    ...
    r = engine->RegisterObjectMethod("XObjectArray", "void ConvertToObjects(CKContext@ context, XObjectPointerArray &out objArray) const", asMETHODPR(XObjectArray, ConvertToObjects, (CKContext *Context, XObjectPointerArray &) const, void), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    ...
    r = engine->RegisterObjectMethod("XObjectArray", "bool Check(CKContext@ obj)", asMETHODPR(XObjectArray, Check, (CKContext *), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XObjectArray", "bool AddIfNotHere(CK_ID id)", asMETHODPR(XObjectArray, AddIfNotHere, (CK_ID), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XObjectArray", "bool AddIfNotHere(CKObject@ obj)", asMETHODPR(XObjectArray, AddIfNotHere, (CKObject *), CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XObjectArray", "CKObject@ GetObject(CKContext@ context, uint i) const", asMETHODPR(XObjectArray, GetObject, (CKContext *, unsigned int) const, CKObject *), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    ...
    r = engine->RegisterObjectMethod("XObjectArray", "bool FindObject(CKObject@ obj) const", asMETHODPR(XObjectArray, FindObject, (CKObject *) const, CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
    r = engine->RegisterObjectMethod("XObjectArray", "bool FindID(CK_ID id) const", asMETHODPR(XObjectArray, FindID, (CK_ID) const, CKBOOL), asCALL_THISCALL); CKAS_CHECK_REGISTER(r);
