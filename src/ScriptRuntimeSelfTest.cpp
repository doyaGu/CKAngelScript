...
bool RunScriptRuntimeSelfTest(CKContext *context, asIScriptEngine *engine, std::string &error) {
    ...
    const char *source =
        ...
        "  if (e2d !is null) { Entity2DRef@ parent2d = e2d.Parent(); Entity2DRef@ child2d = e2d.Child(0); array<Entity2DRef@>@ children2d = e2d.Children(); e2d.ChildCount(); e2d.SetParent(parent2d); e2d.IsAncestorOf(child2d); e2d.IsDescendantOf(parent2d); }\n"
