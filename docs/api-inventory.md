...
| Initialization/diagnostics | `CKAngelScriptInitResult`, `CKAngelScriptInitLoadOptions`, `CKAngelScriptInitImportBindOptions`, `CKAngelScriptInitBytecodeSaveOptions`, `CKAngelScriptInitBytecodeLoadOptions`, `CKAngelScriptInitFunctionOptions`, `CKAngelScriptInitFunctionExecutionOptions`, `CKAngelScriptInitExecutionStepOptions`, `CKAngelScriptInitObjectOptions`, `CKAngelScriptInitMethodOptions`, `CKAngelScriptInitObjectMethodExecuteOptions`, `CKAngelScriptInitEngineExtension`, `CKAngelScriptGetStatusName`, `CKAngelScriptGetStatusDescription` |
