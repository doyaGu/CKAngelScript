...
| Objects/methods | `CKAngelScriptCreateObject`, `CKAngelScriptReleaseObject`, `CKAngelScriptFindObjectMethod`, `CKAngelScriptReleaseMethod`, `CKAngelScriptCallObjectMethod`; object creation accepts `ClassName` with optional `ClassNamespace`, or exact `TypeDecl` |
